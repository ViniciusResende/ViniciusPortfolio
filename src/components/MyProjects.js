        ...
        <Modal visible={isRIVPRVisible} width={modalWidth} height={modalHeight} effect="fadeInUp" onClickAway={() => closeModal()}>
          <div className="modalContainer">
            <div className="modalContent">
              ...
              <p>GitHub Repository: <a href="https://github.com/ViniciusResende/RIVPR" target="_blank">https://github.com/ViniciusResende/RIVPR</a></p> 
        ...
        <Modal visible={isJaveVisible} width={modalWidth} height={modalHeight} effect="fadeInUp" onClickAway={() => closeModal()}>
          <div className="modalContainer">
            <div className="modalContent">
              ...
              <p>GitHub Repository: <a href="https://github.com/ViniciusResende/JaveLogisticaReact" target="_blank">https://github.com/ViniciusResende/JaveLogisticaReact</a></p> 
              <a className="modalClose" href="javascript:void(0);" onClick={() => closeModal()}>fechar</a>
            </div>
          </div>
        </Modal>
        <Modal visible={isMoveitVisible} width={modalWidth} height={modalHeight} effect="fadeInUp" onClickAway={() => closeModal()}>
          <div className="modalContainer">
            <div className="modalContent">
              ...
              <p>GitHub Repository: <a href="https://github.com/ViniciusResende/TimeToMoveIt" target="_blank">https://github.com/ViniciusResende/TimeToMoveIt</a></p> 
              <a className="modalClose" href="javascript:void(0);" onClick={() => closeModal()}>fechar</a>
            </div>
          </div>
        </Modal>
        <Modal visible={isEmailApiVisible} width={modalWidth} height={modalHeight} effect="fadeInUp" onClickAway={() => closeModal()}>
          <div className="modalContainer">
            <div className="modalContent">
              ...
              <p>GitHub Repository: <a href="https://github.com/ViniciusResende/NpsAPI" target="_blank">https://github.com/ViniciusResende/NpsAPI</a></p> 
              <a className="modalClose" href="javascript:void(0);" onClick={() => closeModal()}>fechar</a>
            </div>
          </div>
        </Modal>
