...
function Experience() {
  return (
    <>
      <a id="timeline" className="anchor" href="#"></a>
      <div className="experienceContainer" id="timeline">
        ...
        <div className="experienceContent">
          <div className="contentContainer">          
            ...
            <p className="experienceDescription">Em 2018 iniciei um curso técnico em informática concomitante ao ensino médio, com isso iniciei meus estudos na área da programação principalmente atrelados à lógica de programação em C e Java.</p>
          </div>
          <div className="contentContainer">          
            <h2 className="experienceTitle">2019</h2>
            <p className="experienceDescription">Em 2019 estava no segundo ano do meu curso e atuei pela primeira vez como técnico de informática, também, nesse ano, comecei meus estudos nas tecnologias web, por exemplo HTML, CSS e JavaScript.</p>
          </div>
          <div className="contentContainer">          
